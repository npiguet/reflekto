...
public abstract class MemberCollection<E extends Member, C extends MemberCollection<E, C>> implements Iterable<E> {

	private final Map<String, List<E>> byName;
	private final List<E> iterable = new ArrayList<E>();

	public MemberCollection(boolean named, Collection<? extends E> declared, Collection<? extends C> allInherited) {
		if (named) {
