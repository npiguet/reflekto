...
public class TypeVariable extends AbstractElement implements Type {
	...
	public TypeVariable(java.lang.reflect.TypeVariable<?> var, GenericDeclaration declaration, FullReflector creator) {
		super(creator);
	...
	/**
	 * Builds a TypeVariable where the bounds are modified so that occurences of any of the variables in vars are
	 * replaced by the corresponding value in values, and any occurence of the original type variable is replaced by
	 * this type variable.
	 */
	protected TypeVariable(TypeVariable original, GenericDeclaration declaration, List<TypeVariable> vars,
			List<Type> values) {
	...
	public Type assignVariables(GenericDeclaration declaration, List<TypeVariable> variables, List<Type> values) {
		...
		return new TypeVariable(this, declaration, variables, values);
	}

	/**
	 * If this TypeVariable is part of the variables list then the corresponding value is returned, otherwise this
	 * TypeVarible is returned. This method is supposed to be called when this variable is being *used* (as opposed to
	 * being *declared* as a type parameter).
	 */
	...
	public boolean equals(Object obj) {
		...
		return this.typeVariable.equals(other.typeVariable) && this.genericDeclaration.equals(other.genericDeclaration)
