...
public class WildcardType extends AbstractElement implements Type {
	...
	public WildcardType(java.lang.reflect.WildcardType wildcard, FullReflector reflector) {
		super(reflector);
	...
	public WildcardType(WildcardType original, List<Type> lowerBound, List<Type> upperBound) {
